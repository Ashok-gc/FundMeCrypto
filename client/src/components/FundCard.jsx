...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, handleClick }) => {
  ...
  return (
  <div className="sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer shadow-lg hover:shadow-2xl" onClick={handleClick} style={{ boxShadow: "0px 5px 15px #1db0c0" }}>
